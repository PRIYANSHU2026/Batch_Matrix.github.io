...
export function BatchProvider({ children }: { children: ReactNode }) {
  ...
  if (hasValidProductsWithGF) {
    ...
    // Format components for GF calculation using product MW directly
    ...
    gfResults = compResults.map(c => {
      ...
      if (productInfo !== undefined) {
        // Use product MW and Product Moles for calculation
        return {
          ...c,
          mw: productInfo.productMW, // Use product MW directly
          molQty: (c.matrix * productInfo.productMW * productInfo.productMoles) / 1000, // Use product moles in calculation
